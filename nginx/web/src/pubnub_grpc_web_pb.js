 ...
 * @final
 */
proto.pubnub.PubSubPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
 ...
 */
proto.pubnub.PubSubClient.prototype.publish =
 ...
 */
proto.pubnub.PubSubPromiseClient.prototype.publish =
 ...
 *     The XHR Node Readable Stream
 */
proto.pubnub.PubSubClient.prototype.subscribe =
    function(request, metadata) {
 ...
 *     The XHR Node Readable Stream
 */
proto.pubnub.PubSubPromiseClient.prototype.subscribe =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/pubnub.PubSub/Subscribe',
      request,
