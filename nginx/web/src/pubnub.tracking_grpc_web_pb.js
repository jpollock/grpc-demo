 ...
 * @final
 */
proto.pubnub.DriverTrackingClient =
 ...
 * @final
 */
proto.pubnub.DriverTrackingPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
 ...
 */
proto.pubnub.DriverTrackingClient.prototype.subscribe =
 ...
 *     The XHR Node Readable Stream
 */
proto.pubnub.DriverTrackingPromiseClient.prototype.subscribe =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/pubnub.DriverTracking/Subscribe',
      request,
 ...
 * @final
 */
proto.pubnub.LocationTrackingClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
 ...
 * @final
 */
proto.pubnub.LocationTrackingPromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';
 ...
 *     The XHR Node Readable Stream
 */
proto.pubnub.LocationTrackingClient.prototype.subscribe =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/pubnub.LocationTracking/Subscribe',
      request,
 ...
 *     The XHR Node Readable Stream
 */
proto.pubnub.LocationTrackingPromiseClient.prototype.subscribe =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/pubnub.LocationTracking/Subscribe',
      request,
