...
goog.exportSymbol('proto.pubnub.DriverTrackingMessage.DriverStatus', null, global);
...
goog.exportSymbol('proto.pubnub.LocationTrackingMessage.TrackingStatus', null, global);
/**
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.pubnub.DriverTrackingEnvelope.displayName = 'proto.pubnub.DriverTrackingEnvelope';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.pubnub.DriverTrackingMessage.displayName = 'proto.pubnub.DriverTrackingMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.pubnub.LocationTrackingEnvelope.displayName = 'proto.pubnub.LocationTrackingEnvelope';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.pubnub.LocationTrackingMessage.displayName = 'proto.pubnub.LocationTrackingMessage';
}
 ...
 * @return {!Object}
 */
proto.pubnub.DriverTrackingEnvelope.prototype.toObject = function(opt_includeInstance) {
  return proto.pubnub.DriverTrackingEnvelope.toObject(opt_includeInstance, this);
};
 ...
 */
proto.pubnub.DriverTrackingEnvelope.toObject = function(includeInstance, msg) {
  var f, obj = {
    channel: jspb.Message.getFieldWithDefault(msg, 1, ""),
    data: (f = msg.getData()) && proto.pubnub.DriverTrackingMessage.toObject(includeInstance, f)
  };
...
proto.pubnub.DriverTrackingEnvelope.deserializeBinary = function(bytes) {
  ...
  return proto.pubnub.DriverTrackingEnvelope.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.pubnub.DriverTrackingEnvelope}
 */
proto.pubnub.DriverTrackingEnvelope.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value,proto.pubnub.DriverTrackingMessage.deserializeBinaryFromReader);
      msg.setData(value);
      break;
    default:
      reader.skipField();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.DriverTrackingEnvelope.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
proto.pubnub.DriverTrackingEnvelope.prototype.getData = function() {
  return /** @type{?proto.pubnub.DriverTrackingMessage} */ (
    jspb.Message.getWrapperField(this, proto.pubnub.DriverTrackingMessage, 2));
};
 ...
 * @return {!Object}
 */
proto.pubnub.DriverTrackingMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.pubnub.DriverTrackingMessage.toObject(opt_includeInstance, this);
};
...
proto.pubnub.DriverTrackingMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    customStatus: (f = msg.getCustomStatus()) && google_protobuf_struct_pb.Value.toObject(includeInstance, f),
    location: (f = msg.getLocation()) && pubnub_types_pb.Location.toObject(includeInstance, f),
...
proto.pubnub.DriverTrackingMessage.deserializeBinary = function(bytes) {
  ...
  return proto.pubnub.DriverTrackingMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.pubnub.DriverTrackingMessage}
 */
proto.pubnub.DriverTrackingMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 5:
      ...
      reader.readMessage(value,pubnub_types_pb.Location.deserializeBinaryFromReader);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.DriverTrackingMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      pubnub_types_pb.Location.serializeBinaryToWriter
    );
  }
...
proto.pubnub.DriverTrackingMessage.prototype.getDriverStatus = function() {
  return /** @type {!proto.pubnub.DriverTrackingMessage.DriverStatus} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
...
proto.pubnub.DriverTrackingMessage.prototype.getLocation = function() {
  return /** @type{?proto.pubnub.Location} */ (
    jspb.Message.getWrapperField(this, pubnub_types_pb.Location, 5));
};
 ...
 * @return {!Object}
 */
proto.pubnub.LocationTrackingEnvelope.prototype.toObject = function(opt_includeInstance) {
  return proto.pubnub.LocationTrackingEnvelope.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.LocationTrackingEnvelope.toObject = function(includeInstance, msg) {
  var f, obj = {
    channel: jspb.Message.getFieldWithDefault(msg, 1, ""),
    data: (f = msg.getData()) && proto.pubnub.LocationTrackingMessage.toObject(includeInstance, f)
  };
...
proto.pubnub.LocationTrackingEnvelope.deserializeBinary = function(bytes) {
  ...
  return proto.pubnub.LocationTrackingEnvelope.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.pubnub.LocationTrackingEnvelope}
 */
proto.pubnub.LocationTrackingEnvelope.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      reader.readMessage(value,proto.pubnub.LocationTrackingMessage.deserializeBinaryFromReader);
      msg.setData(value);
      break;
    default:
      reader.skipField();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.LocationTrackingEnvelope.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getChannel();
  if (f.length > 0) {
    writer.writeString(
...
proto.pubnub.LocationTrackingEnvelope.prototype.getData = function() {
  return /** @type{?proto.pubnub.LocationTrackingMessage} */ (
    jspb.Message.getWrapperField(this, proto.pubnub.LocationTrackingMessage, 2));
};
 ...
 * @return {!Object}
 */
proto.pubnub.LocationTrackingMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.pubnub.LocationTrackingMessage.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.LocationTrackingMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
...
proto.pubnub.LocationTrackingMessage.deserializeBinary = function(bytes) {
  ...
  return proto.pubnub.LocationTrackingMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.pubnub.LocationTrackingMessage}
 */
proto.pubnub.LocationTrackingMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.LocationTrackingMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
proto.pubnub.LocationTrackingMessage.prototype.getTrackingStatus = function() {
  return /** @type {!proto.pubnub.LocationTrackingMessage.TrackingStatus} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.pubnub.LocationTrackingMessage} returns this
 */
proto.pubnub.LocationTrackingMessage.prototype.setTrackingStatus = function(value) {
 ...
 * @return {!proto.pubnub.LocationTrackingMessage} returns this
*/
proto.pubnub.LocationTrackingMessage.prototype.setCustomStatus = function(value) {
...
proto.pubnub.LocationTrackingMessage.prototype.getLocation = function() {
  return /** @type{?proto.pubnub.Location} */ (
    jspb.Message.getWrapperField(this, pubnub_types_pb.Location, 4));
};
