 ...
 * @return {!Object}
 */
proto.pubnub.PublishResponse.prototype.toObject = function(opt_includeInstance) {
...
proto.pubnub.PublishResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    timetoken: (f = msg.getTimetoken()) && proto.pubnub.Timetoken.toObject(includeInstance, f),
 ...
 * @return {!proto.pubnub.PublishResponse}
 */
proto.pubnub.PublishResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      reader.readMessage(value,proto.pubnub.Timetoken.deserializeBinaryFromReader);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pubnub.PublishResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.pubnub.Timetoken.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f !== 0.0) {
...
proto.pubnub.PublishResponse.prototype.getTimetoken = function() {
  return /** @type{?proto.pubnub.Timetoken} */ (
    jspb.Message.getWrapperField(this, proto.pubnub.Timetoken, 2));
};
...
proto.pubnub.PublishResponse.prototype.getStatus = function() {
  return /** @type {!proto.pubnub.PublishResponse.Status} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
